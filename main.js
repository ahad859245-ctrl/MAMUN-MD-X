...
global.channelLink = "https://chat.whatsapp.com/Bcn5ZBV9VCF3P4Avet1UiU?mode=hqrt1";
global.ytch = "ᴍᴀᴍᴜɴ ᴀᴅᴍɪɴ";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://chat.whatsapp.com/Bcn5ZBV9VCF3P4Avet1UiU?mode=hqrt1'
                }, { quoted: message });
                return;
